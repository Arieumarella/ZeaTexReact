...
import { getPelanggan, Pelanggan, deletePelanggan } from '../../service/pelangganService';
  ...
  return (
    <div>
      <PageMeta
        ...
        description="Tabel manajemen pelanggan di Zea. Textile"
      />
      <PageBreadcrumb pageTitle="Manajemen Pelanggan" />
        ...
        <ComponentCard title="Daftar Pelanggan">
          <div className="mb-4 flex flex-col gap-2 md:flex-row md:items-center md:gap-2">
            ...
            <button
              ...
              onClick={() => navigate('/tambah-manajemen-pelanggan')}
            >
              + Tambah Pelanggan
            </button>
          </div>
              ...
              <Table>
                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                  <TableRow>
                    ...
                    <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-center text-theme-xs dark:text-gray-400">Nomor WhatsApp</TableCell>
