...
import { getBarang, deleteBarang, Barang } from '../../service/barangService';
                  ...
                  {filteredData.length === 0 ? (
                    ...
                    filteredData.map((item, idx) => (
                      <TableRow key={item.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.04]">
                        ...
                        <TableCell className="px-4 py-2 border text-center text-gray-800 dark:text-white/90">{item.nama_barang}</TableCell>
