...
import { getAllSuppliers, Supplier, getAllBarang, Barang, getTransaksiMasukById, updateTransaksiMasuk } from '../../service/barangMasuk';
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        if (id) {
          const trans = await getTransaksiMasukById(parseInt(id));
          console.log('Fetched transaksi masuk data:', trans);
          if (mounted && trans) {
            ...
            setSuplier(String(trans.supplier?.id || ''));
            setSelectedSupplierName(trans.supplier?.nama || '');
  ...
  return (
    <>
      <PageMeta
        ...
        description="Edit data transaksi barang masuk"
      />
      <PageBreadcrumb
      ...
      <div className="w-full mt-8">
        <ComponentCard title="Form Edit Barang Masuk">
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            {/* Bagian Ketiga: Discount, PPN, Catatan */}
